...
class StudentProfile extends React.Component {
  ...
  // eslint-disable-next-line require-jsdoc
  render() {
    const {forms, basicInfo, currTab, blankForms, parents, authorized, id, tags, years} = this.state;
        ...
        <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
          <div style={{maxWidth: 1000, width: '100%'}}>
            <Paper elevation={2}>
              ...
              <div>
                {currTab === 0 && <FormsTab {...this.props} forms={forms} studentId={basicInfo['_id']} tags={tags} years={years}/>}
